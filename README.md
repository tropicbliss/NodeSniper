...
Use the `-r` flag if you want to skip the prompt of gift code redemption. You can only use this if you are using it in conjunction with the username argument.
